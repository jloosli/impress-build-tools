...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        copy:         {
            main: {
                files: [
                    {src: ['img/**'], dest: '<%= globalConfig.dest %>'},
        ...
        cssmin:       {
            main: {
                ...
                dest: '<%= globalConfig.dest %>app.full.min.css'
            }
        },
        concat:       {
            main: {
        ...
        uglify:       {
            main: {
                src:  'temp/app.full.js',
                dest: '<%= globalConfig.dest %>app.full.min.js'
            }
        },
        htmlmin:      {
            main: {
                ...
                files:   {
                    '<%= globalConfig.dest %>index.html': '<%= globalConfig.dest %>index.html'
                }
            }
        },
        imagemin:     {
            main: {
                files: [{
                    expand: true, cwd: '<%= globalConfig.dest %>',
                    src:    ['**/{*.png,*.jpg}'],
                    dest:   '<%= globalConfig.dest %>'
                }]
            }
        ...
        karma:        {
            ...
            all_tests:    {
                browsers: ['Chrome'] // Removed Firefox and PhantomJS
            },
            during_watch: {
                browsers: ['PhantomJS']
            }
